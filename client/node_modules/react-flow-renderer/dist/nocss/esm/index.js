...
export { i as MiniMap } from './index-df1125f4.js';
export { C as ControlButton, i as Controls } from './index-70dd7795.js';
export { i as Background } from './index-137b3d5b.js';
export { u as useUpdateNodeInternals } from './useUpdateNodeInternals-cf565e89.js';
export { u as useNodes } from './useNodes-6ff81122.js';
export { u as useEdges } from './useEdges-2cda6aa8.js';
export { u as useViewport } from './useViewport-a64121f2.js';
import 'zustand';
...
function getParentNodePosition(nodeInternals, nodeId) {
  var _nodeInternals$get, _parentNode$positionA, _parentNode$positionA2;

  var parentNodeId = nodeId ? (_nodeInternals$get = nodeInternals.get(nodeId)) === null || _nodeInternals$get === void 0 ? void 0 : _nodeInternals$get.parentNode : null;
  var parentNode = parentNodeId ? nodeInternals.get(parentNodeId) : null;
  return {
    x: (parentNode === null || parentNode === void 0 ? void 0 : (_parentNode$positionA = parentNode.positionAbsolute) === null || _parentNode$positionA === void 0 ? void 0 : _parentNode$positionA.x) || 0,
    y: (parentNode === null || parentNode === void 0 ? void 0 : (_parentNode$positionA2 = parentNode.positionAbsolute) === null || _parentNode$positionA2 === void 0 ? void 0 : _parentNode$positionA2.y) || 0
  };
}
...
function updatePosition(dragItem, mousePos, nodeInternals, nodeExtent) {
  ...
  if (dragItem.extent === 'parent') {
    if (dragItem.parentNode && dragItem.width && dragItem.height) {
      ...
      currentExtent = parent !== null && parent !== void 0 && parent.width && parent !== null && parent !== void 0 && parent.height ? [[0, 0], [parent.width - dragItem.width, parent.height - dragItem.height]] : currentExtent;
    } else {
      // @ts-ignore
      if (process.env.NODE_ENV === 'development') {
  ...
  nextPosition = currentExtent ? clampPosition(nextPosition, currentExtent) : nextPosition;
  dragItem.delta = {
...
function getEventHandlerParams(_ref) {
  ...
  var extentedDragItems = dragItems.map(function (n) {
    ...
    return _objectSpread$5(_objectSpread$5({}, node), {}, {
      position: n.position,
      positionAbsolute: {
        x: (((_node$positionAbsolut = node.positionAbsolute) === null || _node$positionAbsolut === void 0 ? void 0 : _node$positionAbsolut.x) || 0) + n.delta.x,
        y: (((_node$positionAbsolut2 = node.positionAbsolute) === null || _node$positionAbsolut2 === void 0 ? void 0 : _node$positionAbsolut2.y) || 0) + n.delta.y
      }
    });
  });
